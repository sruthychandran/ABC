...
public interface RoleService {
	...
	public BasicResponse<RoleResponseDto> deleteRole(String roleId) throws NotFoundException;

	public BasicResponse<RoleResponseDto> updateRole(RoleDto RoleDto) throws NotFoundException, RoleUpdationFailureException;
