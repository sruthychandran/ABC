...
public class PermissionServiceTests {
	 ...
	 * 
	 * @MockBean private PermissionDAO permissionDAO;
	 * 
	 ...
	 * 
	 * @Test public void test_createPermissions_success() throws
	 * JsonMappingException, JsonProcessingException,
	 * PermissionCreationFailureException { PermissionDto permissionDto =
	 ...
	 * permission); PermissionResponseDto returnedUser =
	 * permissionService.savePermission(permissionDto);
	 * assertNotNull(returnedUser.getPermissionId()); assertEquals("EU",
	 * returnedUser.getPermissionId()); assertEquals("end user",
	 * returnedUser.getPermissionName());
	 ...
	 * Mockito.when(permissionDAO.save(Mockito.any(Permission.class))).thenReturn(
	 * permission1); PermissionResponseDto updatedPermission =
	 ...
	 * permissionName("end user").permissionDescription("permissionDescription").
	 * build();
	 * 
