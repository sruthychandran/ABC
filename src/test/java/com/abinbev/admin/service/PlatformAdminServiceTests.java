...
public class PlatformAdminServiceTests {
	...
	/*
	 * @Autowired private PlatformAdminService platformAdminService;
	 * 
	 ...
	 * Date()).createdBy("abi@gmail.com")
	 * 
	 * .build(); User user2 = mapper.readValue(mapToJson(userDto2), User.class);
	 ...
	 * Date()).createdBy("abi@gmail.com")
	 * 
	 * .build(); User user = mapper.readValue(mapToJson(userDto1), User.class);
	 * 
	 * Mockito.when(userDAO.save(Mockito.any(User.class))).thenReturn(user);
	 * UserResponseDto userResponse1 = platformAdminService.saveUser(userDto1);
	 * 
	 ...
	 * UserNotFoundException, UserUpdationFailureException {
	 * 
	 ...
	 * "rafeeq088@gmail.com")
	 * .phoneNo(8089587001l).roleId("TA").status("active").createdBy(
	 * "rafeeq088@gmail.com").build();
	 * 
	 * Mockito.when(userDAO.findByEmail(userResponse1.getEmailId())).thenReturn(
	 * retrievedUser); assertNotNull(retrievedUser.getEmailId()); Date createdDate =
	 * retrievedUser.getCreatedDate(); String createdBy =
	 * retrievedUser.getCreatedBy();
	 * 
	 * User user1 = User.builder().firstName("abdulrafeek").lastName("ks").emailId(
	 * "rafeeq088@gmail.com")
	 ...
	 * assertEquals("abdulrafeek", updatedUser.getFirstName()); assertEquals("ks",
	 ...
	 * UserDto userDto =
	 * UserDto.builder().firstName("rafeek").lastName("ks").emailId(
	 * "rafeeq@gmail.com") .phoneNo(8089587001l).roleId("TA").status("active")
	 * 
	 * .build();
	 * 
	 ...
	 * 
	 * assertThat(platformAdminService.getAllUsers(PageRequest.of(0,
	 ...
	 * 
	 * 
	 * @Test public void test_findByEmailId_success() throws JsonMappingException,
	 * JsonProcessingException, CategoryServiceNotFoundException,
	 ...
	 * 
	 * UserResponseDto userResponseObj =
	 * platformAdminService.findByEmailId("rafeeq088@gmail.com");
	 * 
	 * assertNotNull(userResponseObj.getEmailId()); assertEquals("TA",
	 * userResponseObj.getRoleId()); assertEquals("rafeeq088@gmail.com",
	 * userResponseObj.getEmailId()); assertEquals("rafeek",
	 * userResponseObj.getFirstName()); assertEquals("ks",
	 * userResponseObj.getLastName());
	 * 
	 ...
	 * }
	 * 
	 * @Test public void test_findByEmailId_throws_exception() throws
	 ...
	 * 
	 * @Test public void
	 * test_updateUserService_throws_UserUpdationFailureException() throws
	 * JsonMappingException, JsonProcessingException,
	 * CategoryServiceUpdationFailureException {
	 * 
	 * UserDto userDto =
	 * UserDto.builder().firstName("rafeek").lastName("ks").emailId(
	 * "rafeeq@gmail.com") .phoneNo(8089587001l).roleId("TA").status("active")
	 ...
	 * 
	 * UserUpdationFailureException thrown =
	 * assertThrows(UserUpdationFailureException.class, () ->
