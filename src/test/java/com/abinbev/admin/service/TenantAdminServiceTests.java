...
public class TenantAdminServiceTests {
	...
	public void test_createUserWithExistingEmail()
		...
		assertThrows(EmailExistException.class, () -> tenantAdminService.saveUser(user2));
	...
	public void test_updateUser_throws_exception()
		...
		UserNotFoundException thrown = assertThrows(UserNotFoundException.class,
				() -> tenantAdminService.updateUser(userDto));
		assertEquals("User not found", thrown.getMessage());
	}


	@Test
	public void test_getAllUsers_success() throws JsonMappingException, JsonProcessingException, UserNotFoundException {
		User user1 = User.builder().firstName("rafeek").lastName("ks").emailId("rafeeq088@gmail.com")
				.phoneNo(8089587001l).roleId("TA").status("active").createdDate(new Date())
				.createdBy("rafeeq088@gmail.com").build();
		...
		assertThat(tenantAdminService.getAllUsers(PageRequest.of(0, 20)).getTotalElements()).isEqualTo(2);
