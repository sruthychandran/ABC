...
public class PlatformAdminControllerTests {
	 ...
	 * 
	 * @MockBean private PlatformAdminService platformAdminService;
	 * 
	 ...
	 * UserDto.builder().firstName("rafeek").lastName("ks")
	 * .phoneNo(8089587001l).roleId("TA").status("active").createdDate(new Date())
	 * .createdBy("rafeeq088@gmail.com").build();
	 * 
	 * mockMvc.perform(put("/platform-admin/v1/updateUser").contentType(
	 * "application/json")
	 ...
	 * UserResponseDto.builder().firstName("rafeek").lastName("ks").emailId(
	 * "rafeeq088@gmail.com")
	 * .phoneNo(8089587001l).roleId("TA").status("active").createdDate(new Date())
	 * .createdBy("rafeeq088@gmail.com").build();
	 * 
