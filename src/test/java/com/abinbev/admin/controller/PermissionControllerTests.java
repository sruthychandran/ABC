...
public class PermissionControllerTests {
	 ...
	 * 
	 * @Test public void createPermissions() throws Exception {
	 * 
	 * 
	 ...
	 * mapper.readValue(mapToJson(permissionDto), PermissionResponseDto.class);
	 * 
	 * ObjectMapper mapper=new ObjectMapper();
	 * 
	 * 
	 * String inputInJson = this.mapToJson(permissionDto); String URI =
	 * "/permissions/v1/createPermission";
	 * 
	 * Mockito.when(permissionService.savePermission(Mockito.any(PermissionDto.class
	 * ))).thenReturn(permissionResponseDto);
	 * 
	 ...
	 * 
	 * assertEquals("AU", result.getPermissionId()); assertEquals("Add User",
	 * result.getPermissionName());
	 * assertEquals("Can add a user",result.getPermissionDescription());
	 * assertEquals(HttpStatus.OK.value(), response.getStatus()); }
	 * 
	 * @Test public void updatePermission_success() throws Exception {
	 * 
	 * PermissionDto permissionDto =
	 * PermissionDto.builder().permissionId("AU").permissionName("Add User").
	 * permissionDescription("Can add a user" + "").roleId("EU").build();
	 ...
	 * PermissionResponseDto.builder().permissionId("AU").permissionName("Add User")
	 * .permissionDescription("Can add a user" + "").roleId("EU").createdDate(new
	 * Date(2021, 3, 2)).build();
	 * 
	 * ObjectMapper mapper = new ObjectMapper();
	 * 
	 * String inputInJson = this.mapToJson(permissionDto); String URI =
	 * "/permissions/v1/updatePermission";
	 * 
	 * Mockito.when(permissionService.updatePermission(Mockito.any(PermissionDto.
	 * class))) .thenReturn(permissionResponse);
	 * 
	 * RequestBuilder requestBuilder =
	 ...
	 * 
	 * assertEquals("AU", result.getPermissionId()); assertEquals("Add User",
	 * result.getPermissionName()); assertEquals("Can add a user",
	 * result.getPermissionDescription()); assertEquals("EU", result.getRoleId());
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * }
			 * 
			 * @Test public void getPermissionsById_success() throws Exception {
			 * 
			 * PermissionDto permissionDto =
			 * PermissionDto.builder().permissionId("AU").permissionName("Add User").
			 * permissionDescription("Can add a user" + "").roleId("EU").build();
			 ...
			 * 
			 * String URI =
			 * "/permissions/v1/getPermission/"+permissionDto.getPermissionId();
			 * 
			 * Mockito.when(permissionService.getPermission(permissionDto.getPermissionId())
			 * ).thenReturn(permissionResponse);
			 * 
			 * RequestBuilder requestBuilder =
